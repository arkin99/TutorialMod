...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CLICK_BLOCK = BLOCKS.register("click_block", ClickBlock::new);
    public static final RegistryObject<Block> SUPER_CLICK_BLOCK = BLOCKS.register("super_click_block", SuperClickBlock::new);
}